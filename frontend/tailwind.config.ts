  ...
  theme: {
    extend: {
      colors: {
        ...
        // Calming, accessible color palette for AvPD users
        primary: {
          50: '#f0f7ff',
          100: '#e6f1ff',
          200: '#c7e0ff',
        ...
        // Soft, warm accent colors for positive interactions
        accent: {
          50: '#fef6ee',
          100: '#fdebd7',
          200: '#fad3ae',
        ...
        // Gentle error colors (less alarming)
        error: {
          50: '#fef2f2',
          100: '#fee2e2',
          200: '#fecaca',
