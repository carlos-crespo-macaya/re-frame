        ...
        <div className="container-safe py-8 md:py-12">
          ...
          <section className="max-w-3xl mx-auto text-center mb-12 animate-fade-in">
            ...
            <p className="text-[#999999] max-w-2xl mx-auto">
              <span className="text-sm">{t('cta.learn')} <Link href="/learn-cbt" className="text-brand-green-400 underline hover:text-brand-green-300">{t('cta.learnMore')}</Link></span>
            </p>
          </section>
            ...
            <div className="relative">
              ...
              />
                ...
                <p className="mt-6 text-sm text-neutral-500 text-center">
                  {t('intro.features.private.description')}
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-6">
                ...
                <div className="group">
                  ...
                  <h4 className="font-heading font-medium text-base text-[#EDEDED] mb-3">
                    {t('howItWorks.steps.share.title')}
                  </h4>
                  <p className="text-base text-[#999999] leading-relaxed">
                    {t('howItWorks.steps.share.description')}
                  </p>
                </div>
                ...
                <div className="group">
                  ...
                  <h4 className="font-heading font-medium text-base text-[#EDEDED] mb-3">
                    {t('howItWorks.steps.receive.title')}
                  </h4>
                  <p className="text-base text-[#999999] leading-relaxed">
                    {t('howItWorks.steps.receive.description')}
                  </p>
                </div>
                ...
                <div className="group">
                  ...
                  <h4 className="font-heading font-medium text-base text-[#EDEDED] mb-3">
                    {t('howItWorks.steps.practice.title')}
                  </h4>
                  <p className="text-base text-[#999999] leading-relaxed">
                    {t('howItWorks.steps.practice.description')}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative border-t border-b border-[#3a3a3a] py-8">
                <p className="text-center text-[#999999] max-w-2xl mx-auto leading-relaxed">
                  ...
                  {t.rich('intro.features.evidence.description', {
