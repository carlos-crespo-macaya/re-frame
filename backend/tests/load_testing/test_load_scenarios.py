...
class LoadTestMetrics:
    ...
    def get_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "p95_response_time": round(statistics.quantiles(self.response_times, n=20)[18], 3) if len(self.response_times) > 20 else None,
            "p99_response_time": round(statistics.quantiles(self.response_times, n=100)[98], 3) if len(self.response_times) > 100 else None,
...
class LoadTester:
    ...
    def run_concurrent_requests(self, num_requests: int, max_workers: int = 10) -> dict[str, Any]:
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            futures = [
                executor.submit(self.make_request, "/api/reframe/", request)
    ...
    async def run_burst_test(self, burst_size: int, num_bursts: int, delay_between_bursts: float) -> dict[str, Any]:
    ...
    async def run_sustained_load_test(self, requests_per_second: int, duration_seconds: int) -> dict[str, Any]:
