...
from .adk_base import ReFrameResponse, ReFrameTransparencyData
...
class ADKSessionManager:
        ...
        try:
            ...
            if not intake_result.success:
                ...
                return self._format_final_response(
                    ...
                    transparency_data=[intake_result.transparency_data] if intake_result.transparency_data else []
                )
    ...
    def _parse_intake_response(self, response: str) -> Optional[Dict[str, Any]]:
    ...
    def _parse_cbt_response(self, response: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "transparency": {
                ...
                "detailed_transparency": [
                    data.dict() for data in (transparency_data or [])
                ] if transparency_data else []
            },
            "agent_outputs": {
                "intake": intake_data,
                "cbt": cbt_data,
            } if intake_data or cbt_data else None
        }
