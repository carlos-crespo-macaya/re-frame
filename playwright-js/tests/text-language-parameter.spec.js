...
test.describe('Language Parameter E2E Tests', () => {
  ...
  test('should respect language parameter for Spanish conversation', async ({ page }) => {
    ...
    await page.fill('[data-testid="message-input"]', 'Hola, necesito ayuda con mis pensamientos');
    ...
    const greetingText = await page.textContent('.message-container:first-child');
  ...
  test('should respect language parameter for Portuguese conversation', async ({ page }) => {
    ...
    await page.fill('[data-testid="message-input"]', 'Olá, preciso de ajuda com meus pensamentos');
  ...
  test('should respect language parameter for German conversation', async ({ page }) => {
    ...
    await page.fill('[data-testid="message-input"]', 'Hallo, ich brauche Hilfe mit meinen Gedanken');
  ...
  test('should maintain language throughout conversation phases', async ({ page }) => {
    ...
    await page.fill('[data-testid="message-input"]', 'Hola, quiero trabajar en mis pensamientos');
    await page.click('[data-testid="send-button"]');
    ...
    await page.fill('[data-testid="message-input"]', 'Sí, estoy listo para comenzar');
    await page.click('[data-testid="send-button"]');
    ...
    await page.fill('[data-testid="message-input"]', 'Creo que todos me juzgan cuando hablo en público');
    await page.click('[data-testid="send-button"]');
